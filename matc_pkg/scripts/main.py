...
class GUI():
    ...
    def select_file_path(self):
        ...
        self.root_filename = filedialog.askopenfilename(initialdir=my_path_default,title='Select map file',filetypes=(("png file","*.png"),("yaml file","*.yaml"),("pgm file","*.pgm"),("all files","*.*")))
    ...
    def save_solution(self):
        try:
            self.write_file.write_sol(self.cost,self.sol,self.astar_route,self.write_pos,self.root_filename)
    ...
    def update(self):
        ...
        if self.mode==0:
            ...
            print(f'Fleet Result = {self.astar_route}')
            print(f'Customer Pos ={self.write_pos}')
            print(f'Map Location ={self.root_filename}')
            self.mode = 16
