...
from matc_pkg.traffic import Traffic_Management,Traffic_Service_Server
...
def main(fleet,customer_pos,init_path):
    ...
    state,sub_index,time_n,flag_agent = 0,0,0,0
    ...
    while RUN:
        ...
        if state ==1:
            ...
            if result[-1]!=0.0 :
                ...
                if eul<=0.3 and time_n!=0 and flag_agent == 1:
